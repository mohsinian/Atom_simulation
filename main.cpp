...
void display()
{
    ...
    if (value == -1)
    {
        char cn[] = "Chittagong University of Engineering & Technology";
        drawhead(-650, 900, 0, cn);

        char dn[] = "DEPARTMENT OF COMPUTER SCIENCE & ENGINEERING";
        drawhead(-690, 750, 0, dn);
        ...
        char g1[] = "Dr. Muhammad Ibrahim Khan";
        drawhead(290, -250, 0, g1);
        char d1[] = "Professor, Department of CSE,CUET";
        drawsubhead(290, -300, 0, d1);

        char g2[] = "Md. Mynul Hasan";
        drawhead(290, -400, 0, g2);
        char d2[] = "Asst. Professor, Department of CSE,CUET";
